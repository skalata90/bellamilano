...
@section('content')
            <section>
                  <h1 id="maintext">“The right ingredients <br>for the right food”<br> <a href="" class="hvr-push">Book a table</a></h1>
            ...
            <section>
                <div id="text">
                    <h1>Just the right food <br> <img src="img/span.fw.png" class="graf"></h1>
